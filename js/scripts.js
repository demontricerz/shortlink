...
$(document).ready(function() {
    ...
    $("#registerurl").submit(function(event){
        event.preventDefault(); //prevent default action 
        var form_data = $(this).serialize(); //Encode form elements for submission     
        var post_url=$(this).attr('action');
        $.post( post_url, form_data, function( response ) 
        {
            if(response=="success")
            {
                swal("Success", "Url Created Successfully", "success");
                document.getElementById("registerurl").reset();
                loaddashtable();        
           }
            else
            {
...
function loaddashtable()
{
    $('#dashtable').load('dashtable.php',function(){
        $(".editurl").click(function(){
            var t=$(this).attr('id');
            $("#updateurlform").load("updateurlform.php?urlid="+t,function(){
                document.getElementById("updateurlform").removeAttribute("hidden");
                window.location="#updateurlform";
                $("#updateurl").submit(function(event){
                    event.preventDefault(); //prevent default action 
                    var form_data = $(this).serialize(); //Encode form elements for submission     
                    var post_url=$(this).attr('action');
                    $.post( post_url, form_data, function( response ) 
                    {
                        if(response=="success")
                        {
                            swal("Success", "Url Updated Successfully", "success");
                            document.getElementById("updateurlform").innerHTML="";
                            document.getElementById("updateurlform").setAttribute("hidden",true);
                            loaddashtable();
                        }
                        else
                        {
